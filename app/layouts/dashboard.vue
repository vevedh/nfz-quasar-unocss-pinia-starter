      ...
      <QToolbar class="min-h-16 px-4">
        ...
        <QToolbarTitle class="flex items-center gap-3">
          ...
          <div class="leading-tight">
            <div class="text-base font-700">NFZ Starter</div>
            <div class="text-xs nfz-muted">Nuxt 4 · Quasar · UnoCSS · Pinia</div>
          </div>
        </QToolbarTitle>
      ...
      <QScrollArea class="fit">
        <div class="p-4">
          <div class="nfz-card rounded-2xl p-4 dark:bg-slate-900/60">
            <div class="text-xs uppercase tracking-wide nfz-muted">Session active</div>
            <div class="mt-1 font-700">{{ session.userLabel }}</div>
