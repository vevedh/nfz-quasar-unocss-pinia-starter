...
<template>
  <div class="grid gap-6">
    <section>
      <h1 class="text-3xl font-800">Session</h1>
    ...
    <section class="grid gap-4 md:grid-cols-2">
      <QCard class="nfz-card">
        <QCardSection>
          <div class="text-sm nfz-muted">Utilisateur</div>
      ...
      <QCard class="nfz-card">
        <QCardSection>
          <div class="text-sm nfz-muted">Rôles</div>
    ...
    <QCard class="nfz-card">
      <QCardSection>
        <div class="flex items-center justify-between gap-4">
          <div>
            <div class="font-800">Authorization header</div>
            <div class="nfz-muted text-sm">Résolu par le store session, pas par la page.</div>
          </div>
