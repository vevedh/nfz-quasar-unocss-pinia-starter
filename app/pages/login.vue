    ...
    <section class="nfz-auth-hero hidden p-10 lg:flex lg:flex-col lg:justify-between">
      ...
      <div class="grid grid-cols-3 gap-3">
        <div class="rounded-2xl bg-white/10 p-4 ring-1 ring-white/10">
          <div class="text-2xl font-800">NFZ</div>
          <div class="mt-1 text-sm text-blue-50/70">Runtime Feathers natif</div>
        </div>
        <div class="rounded-2xl bg-white/10 p-4 ring-1 ring-white/10">
          <div class="text-2xl font-800">Pinia</div>
          <div class="mt-1 text-sm text-blue-50/70">Store session</div>
        </div>
        <div class="rounded-2xl bg-white/10 p-4 ring-1 ring-white/10">
          <div class="text-2xl font-800">RBAC</div>
          <div class="mt-1 text-sm text-blue-50/70">Routes protégées</div>
        </div>
      </div>
    </section>
      ...
      <QCard class="w-full max-w-md rounded-3xl border border-slate-200 shadow-xl dark:border-slate-800 dark:bg-slate-900">
        <QCardSection class="p-8">
          <div class="mb-8">
            ...
            <h2 class="text-2xl font-800">Connexion</h2>
